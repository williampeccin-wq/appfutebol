    ...
    <form id="register-form" class="form-stack" autocomplete="on" novalidate>
      ...
      <div class="form-row">
        ...
        <div class="form-group">
          ...
          <input class="input" id="register-birthdate" name="birthDate" type="tel" inputmode="numeric" placeholder="DD/MM/AAAA" maxlength="10" data-date-mask autocomplete="bday" required>
        </div>
      </div>

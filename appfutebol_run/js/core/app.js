...
const BOTTOM_NAV_ICONS = {
  ...
  carne: '<svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M12 4.5C8.5 4.5 5.5 6.5 5.5 9.2c0 1.8.9 3 2.1 4.4 1.2 1.4 2.6 2.8 3.6 4.8.3.6 1.3.6 1.6 0 1-2 2.4-3.4 3.6-4.8 1.2-1.4 2.1-2.6 2.1-4.4C18.5 6.5 15.5 4.5 12 4.5Z"/><path d="M9 9.2h6"/><path d="M12 9.2v5.3"/></svg>',
